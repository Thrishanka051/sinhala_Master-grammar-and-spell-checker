...
const SpellChecker = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const correctionResponse = await fetch('http://127.0.0.1:5000/api/spellchecker2/correct', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(wordData)
      });
      const suggestionsResponse = await fetch('http://127.0.0.1:5000/api/spellchecker2/suggestions', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(wordData)
      });
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <div style={styles.cardInner}>
          <h1 style={styles.title}>Spell Checker 02</h1>
